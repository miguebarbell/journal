...
```
cd existing_repo
git remote add origin https://gitlab.com/miguepro/journal.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/miguepro/journal/-/settings/integrations)
